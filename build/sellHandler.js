...
exports.onWebsocketCreateAuction = void 0;
        ...
        return __generator(this, function (_1) {
            switch (_1.label) {
                case 0:
                    ...
                    if (!(title == 'Manage Auctions')) return [3 /*break*/, 2];
                    clickSlot = void 0;
                ...
                case 1:
                    ...
                    _1.label = 2;
                case 2:
                    if (!(title == 'Create Auction')) return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, utils_1.sleep)(10)];
                case 3:
                    _1.sent();
