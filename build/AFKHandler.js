...
exports.tryToTeleportToIsland = exports.initAFKHandler = void 0;
...
function tryToTeleportToIsland(bot, delayBeforeTeleport) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (!!(scoreboard.find(function (e) { return e.includes('Your Island'); }) || scoreboard.find(function (e) { return e.includes('(1/'); }))) return [3 /*break*/, 6];
                    return [4 /*yield*/, (0, utils_1.sleep)(delayBeforeTeleport)];
                case 5:
                    _a.sent();
